<template>
  <div class="to-image">
    <slot v-if="loading" name="placeholder">
      <div class="to-image__placeholder"></div>
    </slot>
    <slot v-else-if="error" name="error">
      <div class="to-image__error">{{ t('el.image.error') }}</div>
    </slot>
    <img
      v-else
      class="to-image__inner"
      v-bind="$attrs"
      v-on="$listeners"
      @click="clickHandler"
      :src="src"
      :style="imageStyle"
      :class="{ 'to-image__inner--center': alignCenter, 'to-image__preview': preview }">
