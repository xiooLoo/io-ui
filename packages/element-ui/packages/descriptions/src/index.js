...
export default {
  ...
  methods: {
    ...
    getRows() {
      const children = ((this.$slots.default || []).filter(vnode => vnode.tag &&
            vnode.componentOptions && vnode.componentOptions.Ctor.options.name === 'ToDescriptionsItem'));
  ...
  render() {
    ...
    return (
      <div class="to-descriptions">
        {
          (title || extra || $slots.title || $slots.extra)
            ? <div class="to-descriptions__header">
              <div class="to-descriptions__title">
                { $slots.title ? $slots.title : title}
              </div>
              <div class="to-descriptions__extra">
        ...
        <div class="to-descriptions__body">
          <table class={['to-descriptions__table', {'is-bordered': border}, descriptionsSize ? `to-descriptions--${descriptionsSize}` : '']}>
            {rows.map(row => (
