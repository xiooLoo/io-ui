<script>
  import ToCheckbox from '../../../packages/checkbox';
  import ToRadio from '../../../packages/radio';
  ...
  export default {
    ...
    methods: {
      ...
      renderCheckIcon(h) {
        return (
          <i class="to-icon-check to-cascader-node__prefix"></i>
        );
      },

      renderLoadingIcon(h) {
        return (
          <i class="to-icon-loading to-cascader-node__postfix"></i>
        );
      },

      renderExpandIcon(h) {
        return (
          <i class="to-icon-arrow-right to-cascader-node__postfix"></i>
        );
      },
      ...
      renderContent(h) {
        ...
        return (
          <span class="to-cascader-node__label">{ vnode || node.label }</span>
        );
      }
    },
