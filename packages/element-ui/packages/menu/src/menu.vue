  ...
  export default {
    ...
    render (h) {
      const component = (
        <ul
          ...
          class={{
            'to-menu--horizontal': this.mode === 'horizontal',
            'to-menu--collapse': this.collapse,
            "to-menu": true
          }}
        >
          { this.$slots.default }
        ...
        render(createElement, context) {
          const data = {
            ...
            on: {
              ...
              enter(el) {
                addClass(el, 'to-opacity-transition');
                el.style.opacity = 1;
              },

              afterEnter(el) {
                removeClass(el, 'to-opacity-transition');
                el.style.opacity = '';
              },
              ...
              beforeLeave(el) {
                ...
                if (hasClass(el, 'to-menu--collapse')) {
                  removeClass(el, 'to-menu--collapse');
                  el.dataset.oldOverflow = el.style.overflow;
                  el.dataset.scrollWidth = el.clientWidth;
                  addClass(el, 'to-menu--collapse');
                } else {
                  addClass(el, 'to-menu--collapse');
                  el.dataset.oldOverflow = el.style.overflow;
                  el.dataset.scrollWidth = el.clientWidth;
    ...
    watch: {
      ...
      collapse(value) {
        ...
        this.broadcast('ToSubmenu', 'toggle-collapse', value);
      }
    },
    methods: {
