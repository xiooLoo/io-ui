<template>
  <div
    class="to-slider"
    :class="{ 'is-vertical': vertical, 'to-slider--with-input': showInput }"
    role="slider"
    :aria-valuemin="min"
    :aria-valuemax="max"
  ...
  >
    ...
    <div
      class="to-slider__runway"
      :class="{ 'show-input': showInput, 'disabled': sliderDisabled }"
      :style="runwayStyle"
      @click="onSliderClick"
      ref="slider">
      <div
        class="to-slider__bar"
        :style="barStyle">
      </div>
      <slider-button
        :vertical="vertical"
      ...
      <template v-if="markList.length > 0">
        <div>
          <div
            ...
            class="to-slider__stop to-slider__marks-stop"
            :key="key">
          </div>
        </div>
        <div class="to-slider__marks">
          <slider-marker
...
<script type="text/babel">
  import ToInputNumber from '../../input-number';
        ...
        if (this.range && Array.isArray(val)) {
          if (val[1] < this.min) {
            ...
            if (this.valueChanged()) {
              this.dispatch('ToFormItem', 'el.form.change', [this.minValue, this.maxValue]);
