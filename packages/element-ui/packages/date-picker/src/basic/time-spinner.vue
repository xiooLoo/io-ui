<template>
  <div class="to-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <to-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="to-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="to-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="to-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="to-time-spinner__arrow to-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="to-time-spinner__arrow to-icon-arrow-down"></i>
        <ul class="to-time-spinner__list" ref="hours">
          <li
            class="to-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="to-time-spinner__arrow to-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="to-time-spinner__arrow to-icon-arrow-down"></i>
        <ul class="to-time-spinner__list" ref="minutes">
          <li
            class="to-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="to-time-spinner__arrow to-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="to-time-spinner__arrow to-icon-arrow-down"></i>
        <ul class="to-time-spinner__list" ref="seconds">
          <li
