<template>
  <transition name="to-zoom-in-top" @after-enter="handleEnter" @after-leave="handleLeave">
    <div
      v-show="visible"
      class="to-picker-panel to-date-picker to-popper"
      :class="[{
      ...
      <div class="to-picker-panel__body-wrapper">
        ...
        <div class="to-picker-panel__body">
          <div class="to-date-picker__time-header" v-if="showTime">
            <span class="to-date-picker__editor-wrap">
              <to-input
            ...
            <span class="to-date-picker__editor-wrap" v-clickoutside="handleTimePickClose">
              <to-input
                ref="input"
          ...
          <div
            class="to-date-picker__header"
            :class="{ 'to-date-picker__header--bordered': currentView === 'year' || currentView === 'month' }"
            v-show="currentView !== 'time'">
            <button
              type="button"
              @click="prevYear"
              :aria-label="t(`el.datepicker.prevYear`)"
              class="to-picker-panel__icon-btn to-date-picker__prev-btn to-icon-d-arrow-left">
            </button>
            <button
              type="button"
              @click="prevMonth"
              ...
              class="to-picker-panel__icon-btn to-date-picker__prev-btn to-icon-arrow-left">
            </button>
            <span
              @click="showYearPicker"
              role="button"
              class="to-date-picker__header-label">{{ yearLabel }}</span>
            <span
              @click="showMonthPicker"
              v-show="currentView === 'date'"
              role="button"
              class="to-date-picker__header-label"
              :class="{ active: currentView === 'month' }">{{t(`el.datepicker.month${ month + 1 }`)}}</span>
            <button
              type="button"
              @click="nextYear"
              :aria-label="t(`el.datepicker.nextYear`)"
              class="to-picker-panel__icon-btn to-date-picker__next-btn to-icon-d-arrow-right">
            </button>
            <button
              type="button"
              @click="nextMonth"
              ...
              class="to-picker-panel__icon-btn to-date-picker__next-btn to-icon-arrow-right">
            </button>
          </div>

          <div class="to-picker-panel__content">
            <date-table
              v-show="currentView === 'date'"
              @pick="handleDatePick"
...
<script type="text/babel">
  ...
  export default {
    ...
    components: {
      TimePicker, YearTable, MonthTable, DateTable, ToInput, ToButton
    },
