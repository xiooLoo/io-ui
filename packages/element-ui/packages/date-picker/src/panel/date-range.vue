<template>
  <transition name="to-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="to-picker-panel to-date-range-picker to-popper"
      :class="[{
        'has-sidebar': $slots.sidebar || shortcuts,
        'has-time': showTime
      }, popperClass]">
      <div class="to-picker-panel__body-wrapper">
        <slot name="sidebar" class="to-picker-panel__sidebar"></slot>
        <div class="to-picker-panel__sidebar" v-if="shortcuts">
          <button
            type="button"
            class="to-picker-panel__shortcut"
            v-for="(shortcut, key) in shortcuts"
            :key="key"
            @click="handleShortcutClick(shortcut)">{{shortcut.text}}</button>
        </div>
        <div class="to-picker-panel__body">
          <div class="to-date-range-picker__time-header" v-if="showTime">
            <span class="to-date-range-picker__editors-wrap">
              <span class="to-date-range-picker__time-picker-wrap">
                <to-input
                  size="small"
                  :disabled="rangeState.selecting"
                  ref="minInput"
                  :placeholder="t('el.datepicker.startDate')"
                  class="to-date-range-picker__editor"
                  :value="minVisibleDate"
                  @input="val => handleDateInput(val, 'min')"
                  @change="val => handleDateChange(val, 'min')" />
              </span>
              <span class="to-date-range-picker__time-picker-wrap" v-clickoutside="handleMinTimeClose">
                <to-input
                  size="small"
                  class="to-date-range-picker__editor"
                  :disabled="rangeState.selecting"
            ...
            <span class="to-date-range-picker__editors-wrap is-right">
              <span class="to-date-range-picker__time-picker-wrap">
                <to-input
                  size="small"
                  class="to-date-range-picker__editor"
              ...
              <span class="to-date-range-picker__time-picker-wrap" v-clickoutside="handleMaxTimeClose">
                <to-input
                  size="small"
                  class="to-date-range-picker__editor"
                  :disabled="rangeState.selecting"
          ...
          <div class="to-picker-panel__content to-date-range-picker__content is-left">
            <div class="to-date-range-picker__header">
              <button
                type="button"
                @click="leftPrevYear"
                class="to-picker-panel__icon-btn to-icon-d-arrow-left"></button>
              <button
                type="button"
                @click="leftPrevMonth"
                class="to-picker-panel__icon-btn to-icon-arrow-left"></button>
              <button
                type="button"
                @click="leftNextYear"
                v-if="unlinkPanels"
                ...
                class="to-picker-panel__icon-btn to-icon-d-arrow-right"></button>
              <button
                type="button"
                @click="leftNextMonth"
                v-if="unlinkPanels"
                ...
                class="to-picker-panel__icon-btn to-icon-arrow-right"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
          ...
          <div class="to-picker-panel__content to-date-range-picker__content is-right">
            <div class="to-date-range-picker__header">
              <button
                type="button"
                @click="rightPrevYear"
      ...
      <div class="to-picker-panel__footer" v-if="showTime">
        <to-button
          size="mini"
          type="text"
          class="to-picker-panel__link-btn"
          @click="handleClear">
...
<script type="text/babel">
  ...
  export default {
    ...
    components: { TimePicker, DateTable, ToInput, ToButton }
  };
</script>
