<template>
  <transition name="to-zoom-in-top" @before-enter="handleMenuEnter" @after-leave="$emit('dodestroy')">
    <div
      ref="popper"
      v-show="visible"
      :style="{ width: width + 'px' }"
      :class="popperClass"
      class="to-picker-panel time-select to-popper">
      <to-scrollbar noresize wrap-class="to-picker-panel__content">
  ...
  export default {
    ...
    methods: {
      ...
      scrollToOption(selector = '.selected') {
        const menu = this.$refs.popper.querySelector('.to-picker-panel__content');
