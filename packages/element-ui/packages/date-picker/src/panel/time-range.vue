<template>
  <transition
    ...
    <div
      v-show="visible"
      class="to-time-range-picker to-picker-panel to-popper"
      :class="popperClass">
      <div class="to-time-range-picker__content">
        <div class="to-time-range-picker__cell">
          <div class="to-time-range-picker__header">{{ t('el.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="to-time-range-picker__body to-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="to-time-range-picker__cell">
          <div class="to-time-range-picker__header">{{ t('el.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="to-time-range-picker__body to-time-panel__content">
            <time-spinner
      ...
      <div class="to-time-panel__footer">
        <button
          type="button"
          class="to-time-panel__btn cancel"
          @click="handleCancel()">{{ t('el.datepicker.cancel') }}</button>
        <button
          type="button"
          class="to-time-panel__btn confirm"
          @click="handleConfirm()"
