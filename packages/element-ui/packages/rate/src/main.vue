    ...
    <span
      ...
      <i
        ...
        <i
          ...
          :style="decimalStyle"
          class="to-rate__decimal">
        </i>
      </i>
    </span>
    <span v-if="showText || showScore" class="to-rate__text" :style="{ color: textColor }">{{ text }}</span>
  </div>
</template>
  ...
  export default {
    ...
    props: {
      ...
      iconClasses: {
        type: [Array, Object],
        default() {
          return ['to-icon-star-on', 'to-icon-star-on', 'to-icon-star-on'];
        }
      },
      voidIconClass: {
        type: String,
        default: 'to-icon-star-off'
      },
      disabledVoidIconClass: {
        type: String,
        default: 'to-icon-star-on'
      },
      disabled: {
        type: Boolean,
        default: false
    ...
    methods: {
      ...
      setCurrentValue(value, event) {
        ...
        if (this.allowHalf) {
          ...
          if (hasClass(target, 'to-rate__item')) {
            target = target.querySelector('.to-rate__icon');
          }
          if (hasClass(target, 'to-rate__decimal')) {
