    ...
    <div class="ops-login-mid">
      <div class="mid-left">
        ...
        <div class="mid-left-down">
          <div class="ic-item" v-for="ic in midIcs" :key="ic.id">
            <yxt-image-view class="ic-svg" :src="ic.src" fit="fill" />
            <span>{{ ic.name }}</span>
          </div>
        </div>
      </div>
...
.ops-login {
  ...
  width: 100%;
  height: 100%;
  background-image: url('https://pic.imgdb.cn/item/648a73be1ddac507cc9757a2.png');
